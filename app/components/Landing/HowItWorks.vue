			...
			<div class="grid lg:grid-cols-2 gap-8 items-center">
				...
				<div class="lg:order-1">
					<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<Card
							class="relative hover:shadow-lg transition-shadow min-h-[240px] flex flex-col bg-slate-50/50 border-slate-200 shadow-xl"
						>
							<div
								class="absolute top-4 left-4 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold"
							>
								1
							</div>
							<CardHeader class="pt-16 text-center flex-1">
								<div
									class="mx-auto mb-4 w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center"
								>
						...
						>
							<div
								class="absolute top-4 left-4 w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center text-sm font-bold"
							>
								2
							</div>
							<CardHeader class="pt-16 text-center flex-1">
						...
						>
							<div
								class="absolute top-4 left-4 w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold"
							>
								3
							</div>
							<CardHeader class="pt-16 text-center flex-1">
